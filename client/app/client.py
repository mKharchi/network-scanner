...
_load_env_file(CLIENT_DIR / ".env")  # legacy compatibility during migration

SERVER_IP = os.getenv("SERVER_IP", "127.0.0.1")
SERVER_PORT = int(os.getenv("SERVER_PORT", "5000"))
ALERT_STATE_FILE = str(STORAGE_DIR / "reported_alerts.json")
NEIGHBOUR_SNAPSHOT_STATE_FILE = str(STORAGE_DIR / "neighbour_snapshot_state.json")
STARTUP_LOG_FILE = LOG_DIR / "client_service.log"
...
def _heartbeat_loop(connection, stop_event):
