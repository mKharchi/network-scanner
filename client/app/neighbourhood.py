...
DEFAULT_NEIGHBOURHOOD_STORAGE_DIR = CLIENT_ROOT / "storage" / "network_neighbourhood"
NEIGHBOUR_SNAPSHOT_STATE_FILE = CLIENT_ROOT / "storage" / "neighbour_snapshot_state.json"
