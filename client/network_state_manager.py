...
DEFAULT_STATE_PATH = (
    Path(__file__).resolve().parent / "storage" / "device_isolation" / "state.json"
)
DEFAULT_STATUS_PATH = (
    Path(__file__).resolve().parent / "storage" / "device_isolation" / "status.json"
)
DEFAULT_AUDIT_PATH = (
    Path(__file__).resolve().parent / "storage" / "device_isolation" / "audit.jsonl"
)
