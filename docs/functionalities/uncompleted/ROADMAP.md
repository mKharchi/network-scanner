...
These historical plans and active proposals are organized under the uncompleted modules:

- [3D visualization plans](02-3d-and-ar-visualization/new-plan.md)
- [AR-enhanced topology plan](02-3d-and-ar-visualization/02-ar-enhanced-3d-topology-visualization.md)
- [ML intelligence & fingerprinting plans](01-ml-intelligence/README.md)
- [Autonomous edge-agent plan](03-autonomous-edge-agent/03-autonomous-edge-ai-self-healing-agent.md)
- [Spatial triangulation plan](04-spatial-triangulation/01-spatial-temporal-rogue-device-triangulation.md)
- [Distributed sensor mesh plan](05-kismet-sensor-mesh/SENSOR_COVERAGE_ARCHITECTURE.md)
- [Neighbourhood orchestration plan](06-managed-client-orchestration/collection-orchestration-plan.md)
